...
export interface NormTableData {
  ...
  /**
   * Optional raw-to-percentile curve from the norming sample. Present on
   * tables generated by a validation study; when it is, a person's reported
   * percentile is read off the curve rather than approximated by the
